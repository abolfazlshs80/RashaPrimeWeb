...
public static class CustomHtmlHelper
{
	...
	public static IHtmlContent CustomCkEditorHtmlHelper(this IHtmlHelper htmlHelper, string name, string value = "", string title = "")
	{
		...
		string myTag = $"\r\n\t\t\t\t<br />\r\n\t\t\t\t<h5>{title}</h5><textarea name=\"{name}\" class=\"editor\" class=\"w-75 mt-3\">{value}</textarea>";
 ...
 //                   </div>");
	...
	public static IHtmlContent CustomPagInationHelper(this IHtmlHelper htmlHelper, string ControllerName, int Count, int PageNumber)
	{
		...
		html.Append($"<nav aria-label=\"Page navigation\" class=\"d-flex justify-content-center mt-5\"><ul class=\"pagination pagination-lg\"><li class=\"page-item prev {statusPagePre}\"><a class=\"page-link\" href=\"/Admin/{ControllerName}/Index/{PageNumber - 1}\"><i class=\"tf-icon bx bx-chevrons-left\"></i></a></li>");
		...
		html.Append($"<li class= \"page-item next {statusPageNext}\" ><a class=\"page-link\" href= \"/Admin/{ControllerName}/Index/{PageNumber + 1}\" ><i class=\"tf-icon bx bx-chevrons-right\"></i></a></li></ul></nav>");
